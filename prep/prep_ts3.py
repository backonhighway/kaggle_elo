...
old_train, old_test, new_train, new_test = ts_fe2.TsFe2().do_fe(older, newer, train, test)
timer.time("done fe")
...
csv_io.output_csv(old_train, path_const.TS_OLD_TRAIN2)
csv_io.output_csv(old_test, path_const.TS_OLD_TEST2)
csv_io.output_csv(new_train, path_const.TS_NEW_TRAIN2)
csv_io.output_csv(new_test, path_const.TS_NEW_TEST2)
