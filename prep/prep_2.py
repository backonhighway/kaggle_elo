...
from elo.fe import para_fe2, encoded_fe
...
fer = encoded_fe.EncodeFe("new")
new_trans = para_fe2.ParaFe(fer).do_para_fe(newer)
fer = encoded_fe.EncodeFe("old")
...
csv_io.output_csv(old_trans, path_const.OLD_TRANS2)
csv_io.output_csv(new_trans, path_const.NEW_TRANS2)
