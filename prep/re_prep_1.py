...
from elo.fe import para_fe2, re_agg_fe
...
fer = re_agg_fe.ReAggFe("new")
new_trans = para_fe2.ParaFe(fer).do_para_fe(newer)
fer = re_agg_fe.ReAggFe("old")
...
csv_io.output_csv(old_trans, path_const.RE_OLD_TRANS1)
csv_io.output_csv(new_trans, path_const.RE_NEW_TRANS1)
