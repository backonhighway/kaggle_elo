...
TS_OLD_TRAIN2 = os.path.join(INPUT_DIR, "ts_old_train2.csv")
TS_OLD_TEST2 = os.path.join(INPUT_DIR, "ts_old_test2.csv")
TS_NEW_TRAIN2 = os.path.join(INPUT_DIR, "ts_new_train2.csv")
TS_NEW_TEST2 = os.path.join(INPUT_DIR, "ts_new_test2.csv")
NEW_TS_PRED_SUB2 = os.path.join(PRED_DIR, "new_ts_pred_sub2.csv")
NEW_TS_PRED_OOF2 = os.path.join(PRED_DIR, "new_ts_pred_oof2.csv")
OLD_TS_PRED_SUB2 = os.path.join(PRED_DIR, "old_ts_pred_sub2.csv")
OLD_TS_PRED_OOF2 = os.path.join(PRED_DIR, "old_ts_pred_oof2.csv")
FEAT_FROM_TS_OLD2 = os.path.join(INPUT_DIR, "feat_from_ts_old2.csv")
FEAT_FROM_TS_NEW2 = os.path.join(INPUT_DIR, "feat_from_ts_new2.csv")
