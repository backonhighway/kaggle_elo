...
ts_train, ts_test = loader.load_ts_input_old()
...
pred_col_name = "pred_from_old_ts"
...
submission.to_csv(path_const.OLD_TS_PRED_SUB, index=False)

train_cv[pred_col_name] = train_cv[pred_col_name] / bagging_num
train_cv.to_csv(path_const.OLD_TS_PRED_OOF, index=False)
