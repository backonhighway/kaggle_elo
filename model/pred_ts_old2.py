...
ts_train, ts_test = loader.load_ts_input_old2()
...
pred_col_name = "pred_from_old_ts2"
...
submission.to_csv(path_const.OLD_TS_PRED_SUB2, index=False)

train_cv[pred_col_name] = train_cv[pred_col_name] / bagging_num
train_cv.to_csv(path_const.OLD_TS_PRED_OOF2, index=False)
