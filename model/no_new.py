...
train_no_new = _train[_train["new_purchase_amount_count"] == 0]
test_no_new = _test[_test["new_purchase_amount_count"] == 0]
train_with_new = _train[_train["new_purchase_amount_count"] > 0]
test_with_new = _test[_test["new_purchase_amount_count"] > 0]
try_some(train_no_new, test_no_new)
try_some(train_with_new, test_with_new)
